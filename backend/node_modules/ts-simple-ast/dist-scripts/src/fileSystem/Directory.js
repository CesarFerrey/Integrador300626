...
var Directory = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        path = this.getPath();
                        this.remove();
                        return [4 /*yield*/, fileSystemWrapper.deleteImmediately(path)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Directory.prototype.save = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, utils_1.FileUtils.ensureDirectoryExists(this.global.fileSystemWrapper, this.getPath())];
                    case 1:
                        _a.sent();
                        unsavedSourceFiles = this.getSourceFiles().filter(function (s) { return !s.isSaved(); });
                        return [4 /*yield*/, Promise.all(unsavedSourceFiles.map(function (s) { return s.save(); }))];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, Promise.all(this.getDirectories().map(function (d) { return d.save(); }))];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Directory.prototype.saveSync = function () {
        utils_1.FileUtils.ensureDirectoryExistsSync(this.global.fileSystemWrapper, this.getPath());
        var unsavedSourceFiles = this.getSourceFiles().filter(function (s) { return !s.isSaved(); });
        unsavedSourceFiles.forEach(function (s) { return s.saveSync(); });
        this.getDirectories().map(function (d) { return d.saveSync(); });
    };
    /** @internal */
    ...
    /** @internal */
    Directory.prototype._fillParentIfNotRoot = function () {
        if (this._parent != null || utils_1.FileUtils.isRootDirPath(this.getPath()))
            return;
        this.addExistingDirectoryIfExists(utils_1.FileUtils.getDirPath(this.getPath()));
    };
    /** @internal */
