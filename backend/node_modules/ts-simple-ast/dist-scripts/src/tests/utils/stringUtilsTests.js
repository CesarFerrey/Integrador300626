...
describe("StringUtils", function () {
    ...
    describe("escapeForWithinString", function () {
        function doTest(input, expected) {
            chai_1.expect(utils_1.StringUtils.escapeForWithinString(input, compiler_1.QuoteKind.Double)).to.equal(expected);
        }
        it("should escape the quotes and newline", function () {
            doTest("\"testing\n this out\"", "\\\"testing\\\n this out\\\"");
        });
    });
