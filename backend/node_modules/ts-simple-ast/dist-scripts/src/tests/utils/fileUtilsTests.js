...
describe("FileUtils", function () {
    ...
    describe("pathStartsWith", function () {
        ...
        it("should return true for the root directory", function () {
            chai_1.expect(utils_1.FileUtils.pathStartsWith("/dir", "/")).to.be.true;
        });
        it("should return true for the root directory on windows", function () {
            chai_1.expect(utils_1.FileUtils.pathStartsWith("C:/dir", "C:/")).to.be.true;
        });
    ...
    describe("getParentMostPaths", function () {
        function doTest(paths, expected) {
            chai_1.expect(utils_1.FileUtils.getParentMostPaths(paths).sort()).to.deep.equal(expected.sort());
        }
        it("should get the parent-most paths", function () {
            doTest(["/dir/child", "/dir", "/dir/child/2"], ["/dir"]);
        });
        it("should get the parent-most paths for sub directories", function () {
