...
describe("VariableDeclarationList", function () {
    describe("getDeclarationKind", function () {
        function doTest(code, expectedType) {
            var firstChild = testHelpers_1.getInfoFromText(code).firstChild;
            chai_1.expect(firstChild.getDeclarationKind()).to.equal(expectedType);
        }
        it("should get var for a var variable", function () {
            doTest("var myVar;", compiler_1.VariableDeclarationKind.Var);
        });
        it("should get let for a let variable", function () {
            doTest("let myVar;", compiler_1.VariableDeclarationKind.Let);
        });
        it("should get const for a const variable", function () {
            doTest("const myVar = 3;", compiler_1.VariableDeclarationKind.Const);
        });
    });
    describe("getDeclarationKindKeyword", function () {
        function doTest(code, expectedType) {
            var firstChild = testHelpers_1.getInfoFromText(code).firstChild;
            chai_1.expect(firstChild.getDeclarationKindKeyword().getText()).to.equal(expectedType);
        }
        it("should get var for a var variable", function () {
            doTest("var myVar;", compiler_1.VariableDeclarationKind.Var);
        });
    ...
    describe("setDeclarationKind", function () {
        ...
        it("should not change the type when it is the same", function () {
            doTest("var myVar;", compiler_1.VariableDeclarationKind.Var, "var myVar;");
        });
        it("should change to let", function () {
            doTest("var myVar;", compiler_1.VariableDeclarationKind.Let, "let myVar;");
        });
        it("should change to const", function () {
            doTest("var myVar;", compiler_1.VariableDeclarationKind.Const, "const myVar;");
        });
        it("should change to var", function () {
            doTest("let myVar;", compiler_1.VariableDeclarationKind.Var, "var myVar;");
        });
    });
    ...
    describe("fill", function () {
        ...
        it("should set the variable declaration kind", function () {
            doTest("const t = '';", { declarationKind: compiler_1.VariableDeclarationKind.Let }, "let t = '';");
        });
        it("should add declarations", function () {
