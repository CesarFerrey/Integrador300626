...
describe("SourceFile", function () {
    describe("copy", function () {
        describe("general", function () {
            ...
            var _a = testHelpers_1.getInfoFromText(fileText, { filePath: "Folder/File.ts", languageVersion: typescript_1.ScriptTarget.ES5 }), sourceFile = _a.sourceFile, project = _a.project;
            ...
            it("should have the same language version after copying", function () {
                chai_1.expect(relativeSourceFile.getLanguageVersion()).to.equal(typescript_1.ScriptTarget.ES5);
            });
    ...
    describe("move", function () {
        function doTest(filePath, newFilePath, absoluteNewFilePath, overwrite) {
            var fileText = "    interface Identifier {}    ";
            var _a = testHelpers_1.getInfoFromText(fileText, { filePath: filePath, languageVersion: typescript_1.ScriptTarget.ES5 }), sourceFile = _a.sourceFile, project = _a.project;
            var fileSystem = project.getFileSystem();
    ...
    describe("insertImportDeclarations", function () {
        function doTest(startCode, index, structures, expectedCode, useSingleQuotes) {
            ...
            if (useSingleQuotes)
                project.manipulationSettings.set({ quoteKind: compiler_1.QuoteKind.Single });
    ...
    describe("formatText", function () {
        ...
        it("should by default add spaces immediately within named import braces", function () {
        ...
        it("should format the text with four spaces", function () {
            doTest("class MyClass {\n    myMethod() {\n    }\n}", "class MyClass {\n    myMethod() {\n    }\n}\n", { indentationText: options_1.IndentationText.FourSpaces });
        });
        it("should format the text with two spaces", function () {
            doTest("class MyClass {\n    myMethod() {\n        console.log(t);\n    }\n}", "class MyClass {\n  myMethod() {\n    console.log(t);\n  }\n}\n", { indentationText: options_1.IndentationText.TwoSpaces });
        });
        it("should format the text with tabs", function () {
            doTest("class MyClass {\n    myMethod() {\n    }\n}", "class MyClass {\n\tmyMethod() {\n\t}\n}\n", { indentationText: options_1.IndentationText.Tab });
        });
        ...
        it("should format the text with slash r slash n newlines", function () {
            doTest("class MyClass {\n    myMethod() {\n    }\n}", "class MyClass {\r\n\tmyMethod() {\r\n\t}\r\n}\r\n", { indentationText: options_1.IndentationText.Tab, newLineKind: typescript_1.NewLineKind.CarriageReturnLineFeed });
        });
        it("should format the text with slash n newlines", function () {
            doTest("class MyClass {\r\n    myMethod() {\r\n    }\r\n}", "class MyClass {\n\tmyMethod() {\n\t}\n}\n", { indentationText: options_1.IndentationText.Tab, newLineKind: typescript_1.NewLineKind.LineFeed });
        });
    ...
    describe("indent", function () {
        ...
        it("should indent when only specifying two spaces", function () {
            ...
            sourceFile.global.manipulationSettings.set({ indentationText: options_1.IndentationText.TwoSpaces });
            sourceFile.indent(0);
            chai_1.expect(sourceFile.getFullText()).to.equal("  //code");
        });
        it("should indent when specifying tabs", function () {
            var sourceFile = testHelpers_1.getInfoFromText("//code").sourceFile;
            sourceFile.global.manipulationSettings.set({ indentationText: options_1.IndentationText.Tab });
            sourceFile.indent(0);
            chai_1.expect(sourceFile.getFullText()).to.equal("\t//code");
        });
    });
    ...
    describe("getReferencingLiteralsInOtherSourceFiles", function () {
        ...
        it("should get the imports, exports, import equals, and dynamic imports that reference this source file", function () {
            ...
            var file3 = project.createSourceFile("/sub/file3.ts", "export * from \"../MyInterface\";\n" +
                ...
                "async function t() { const u = await import(\"../MyInterface\"); }");
            var file4 = project.createSourceFile("/file4.ts", "export * from \"./sub/MyInterface\";\nimport \"MyOtherFile\";");
            var referencing = sourceFile.getReferencingLiteralsInOtherSourceFiles();
            chai_1.expect(referencing.map(function (r) { return r.getText(); }).sort()).to.deep.equal(__spread(__spread(file1.getImportDeclarations(), file2.getImportDeclarations(), file3.getExportDeclarations()).map(function (d) { return d.getModuleSpecifier().getText(); }), ["\"../MyInterface\"", "\"../MyInterface\""]).sort());
        });
    });
    ...
    describe("organizeImports", function () {
        function doTest(fileText, otherFiles, expectedText) {
            var _a = testHelpers_1.getInfoFromText(fileText, { filePath: "/main.ts" }), sourceFile = _a.sourceFile, project = _a.project;
            otherFiles.forEach(function (f) { return project.createSourceFile(f.path, f.text); });
            sourceFile.organizeImports();
            chai_1.expect(sourceFile.getFullText()).to.equal(expectedText);
        }
        it("should organize imports and remove unused ones", function () {
            var startText = "import MyInterface from './MyInterface';\nimport MyClass from './MyClass';\n" +
                "import UnusedInterface from './UnusedInterface';\n\n" +
                "const myVar: MyInterface = new MyClass();";
            var expectedText = "import MyClass from './MyClass';\nimport MyInterface from './MyInterface';\n\n" +
                "const myVar: MyInterface = new MyClass();";
            doTest(startText, [
