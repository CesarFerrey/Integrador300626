...
describe("ImportDeclaration", function () {
    ...
    describe("getModuleSpecifier", function () {
        ...
        it("should get the module specifier", function () {
    ...
    describe("insertNamedImports", function () {
        function doTest(text, index, structuresOrNames, expected, surroundWithSpaces) {
        ...
        it("should insert named imports at the start when it shouldn't use a space", function () {
        ...
        it("should insert named imports at the end when it shouldn't use a space", function () {
