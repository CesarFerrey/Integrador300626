...
describe("ExportDeclaration", function () {
    ...
    describe("getModuleSpecifier", function () {
        function doTest(text, expected) {
            var firstChild = testHelpers_1.getInfoFromText(text).firstChild;
            if (expected == null)
                chai_1.expect(firstChild.getModuleSpecifier()).to.equal(undefined);
            else
                chai_1.expect(firstChild.getModuleSpecifier().getText()).to.equal(expected);
        }
        it("should get the module specifier text", function () {
    ...
    describe("getModuleSpecifierValue", function () {
        function doTest(text, expected) {
            var firstChild = testHelpers_1.getInfoFromText(text).firstChild;
            chai_1.expect(firstChild.getModuleSpecifierValue()).to.equal(expected);
        }
    ...
    describe("insertNamedExports", function () {
        function doTest(text, index, structures, expected, surroundWithSpaces) {
            if (surroundWithSpaces === void 0) { surroundWithSpaces = true; }
            var _a = testHelpers_1.getInfoFromText(text), firstChild = _a.firstChild, sourceFile = _a.sourceFile;
        ...
        it("should insert named exports at the start when it shouldn't use a space", function () {
        ...
        it("should insert named exports at the end when it shouldn't use a space", function () {
