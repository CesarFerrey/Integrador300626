...
describe("NamespaceDeclaration", function () {
    ...
    describe("getDeclarationKindKeyword", function () {
        it("should get the declaration kind keyword for a namespace", function () {
            var firstChild = testHelpers_1.getInfoFromText("namespace Identifier {}").firstChild;
            chai_1.expect(firstChild.getDeclarationKindKeyword().getText()).equals("namespace");
        });
        it("should get the declaration kind keyword for a module", function () {
            var firstChild = testHelpers_1.getInfoFromText("module Identifier {}").firstChild;
            chai_1.expect(firstChild.getDeclarationKindKeyword().getText()).equals("module");
        });
    });
    describe("setHasNamespaceKeyword", function () {
        it("should change the declaration kind when a module", function () {
        ...
        it("should change the declaration kind when a namespace", function () {
