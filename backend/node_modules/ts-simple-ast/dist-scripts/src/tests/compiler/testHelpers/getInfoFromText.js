...
function getInfoFromTextInternal(text, opts) {
    ...
    if (includeLibDts) {
        try {
            ...
            try {
                if (libFiles_1_1 && !libFiles_1_1.done && (_k = libFiles_1.return)) _k.call(libFiles_1);
            }
            finally { if (e_1) throw e_1.error; }
        }
    }
    var project = new Project_1.Project({ compilerOptions: compilerOptions }, host);
    var sourceFile = project.createSourceFile(getFilePath(), text, { languageVersion: languageVersion });
