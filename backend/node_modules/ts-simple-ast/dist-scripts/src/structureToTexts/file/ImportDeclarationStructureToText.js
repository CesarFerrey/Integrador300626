...
var NamedImportExportSpecifierStructureToText_1 = require("./NamedImportExportSpecifierStructureToText");
var ImportDeclarationStructureToText = /** @class */ (function (_super) {
    __extends(ImportDeclarationStructureToText, _super);
    function ImportDeclarationStructureToText(writer, formatSettings) {
        var _this = _super.call(this, writer) || this;
        _this.formatSettings = formatSettings;
        _this.namedImportExportSpecifierStructureToText = new NamedImportExportSpecifierStructureToText_1.NamedImportExportSpecifierStructureToText(writer, formatSettings);
        return _this;
    }
