...
var QuoteKind_1 = require("../literal/QuoteKind");
var Node = /** @class */ (function () {
    ...
    Node.prototype.getDescendantStatements = function () {
        ...
        function handleStatements(thisNode, node) {
            if (node.statements == null)
                return false;
            try {
                for (var _a = __values(node.statements), _b = _a.next(); !_b.done; _b = _a.next()) {
    ...
    Node.prototype.getFirstAncestorByKind = function (kind) {
        try {
            for (var _a = __values(this.getAncestors(kind === typescript_1.SyntaxKind.SyntaxList)), _b = _a.next(); !_b.done; _b = _a.next()) {
                var parent = _b.value;
    ...
    Node.prototype.getWriter = function () {
        ...
        return new code_block_writer_1.default({
            ...
            useSingleQuote: this.global.manipulationSettings.getQuoteKind() === QuoteKind_1.QuoteKind.Single
        });
    };
    /**
