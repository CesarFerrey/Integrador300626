...
var VariableDeclarationList = /** @class */ (function (_super) {
    ...
    VariableDeclarationList.prototype.insertDeclarations = function (index, structures) {
        ...
        var structureToText = new structureToTexts_1.CommaSeparatedStructuresToText(writer, new structureToTexts_1.VariableDeclarationStructureToText(writer));
        ...
        var declarations = manipulation_1.getNodesToReturn(this.getDeclarations(), index, structures.length);
