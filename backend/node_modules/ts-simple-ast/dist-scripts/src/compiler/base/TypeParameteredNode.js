...
function TypeParameteredNode(Base) {
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.insertTypeParameters = function (index, structures) {
            ...
            var structureToText = new structureToTexts_1.CommaSeparatedStructuresToText(writer, new structureToTexts_1.TypeParameterDeclarationStructureToText(writer));
