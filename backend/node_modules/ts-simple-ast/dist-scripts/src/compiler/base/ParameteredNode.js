...
function ParameteredNode(Base) {
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.insertParameters = function (index, structures) {
            ...
            var structureToText = new structureToTexts_1.CommaSeparatedStructuresToText(writer, new structureToTexts_1.ParameterDeclarationStructureToText(writer));
            ...
            var newParameters = manipulation_1.getNodesToReturn(this.getParameters(), index, structures.length);
