...
var EnumDeclaration = /** @class */ (function (_super) {
    ...
    EnumDeclaration.prototype.insertMembers = function (index, structures) {
        ...
        var structureToText = new structureToTexts_1.CommaNewLineSeparatedStructuresToText(writer, new structureToTexts_1.EnumMemberStructureToText(writer));
        ...
        // get the members
        var newMembers = manipulation_1.getNodesToReturn(this.getMembers(), index, structures.length);
