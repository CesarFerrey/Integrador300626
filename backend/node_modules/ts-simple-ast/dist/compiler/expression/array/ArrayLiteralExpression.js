...
var ArrayLiteralExpression = /** @class */ (function (_super) {
    ...
    ArrayLiteralExpression.prototype.insertElements = function (index, textsOrWriterFunction, options) {
        ...
        var stringStructureToText = new structureToTexts_1.StringStructureToText(writer);
        var structureToText = useNewLines ?
            new structureToTexts_1.CommaNewLineSeparatedStructuresToText(writer, stringStructureToText) :
            new structureToTexts_1.CommaSeparatedStructuresToText(writer, stringStructureToText);
