    ...
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.insertFunctions = function (index, structures) {
            ...
            var newChildren = this._insertMainChildren(index, texts, structures, typescript_1.SyntaxKind.FunctionDeclaration, function (child, i) {
                ...
                previousBlanklineWhen: function (previousMember, firstStructure) { return !firstStructure.hasDeclareKeyword || manipulation_1.hasBody(previousMember); },
                separatorNewlineWhen: function (previousStructure, nextStructure) { return !previousStructure.hasDeclareKeyword || !nextStructure.hasDeclareKeyword; },
                nextBlanklineWhen: function (nextMember, lastStructure) { return !lastStructure.hasDeclareKeyword || manipulation_1.hasBody(nextMember); }
            });
            return newChildren;
        };
        ...
        class_1.prototype._insertMainChildren = function (index, childCodes, structures, expectedSyntaxKind, withEachChild, opts) {
            ...
            var finalChildCodes = [];
            var childIndentLevel = this.getChildIndentationLevel();
