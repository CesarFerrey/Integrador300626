...
var CompilerFactory = /** @class */ (function () {
    ...
    CompilerFactory.prototype.createSourceFile = function (filePath, structureOrText, options) {
        ...
        var sourceFile = this.createSourceFileFromText(filePath, "", options);
    ...
    CompilerFactory.prototype.getSourceFile = function (compilerSourceFile) {
        ...
        return this.nodeCache.getOrCreate(compilerSourceFile, function () {
            var sourceFile = new compiler_1.SourceFile(_this.global, compilerSourceFile);
            _this.addSourceFileToCache(sourceFile);
            return sourceFile;
        });
    };
